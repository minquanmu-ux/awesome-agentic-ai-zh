...
→ 接下来 [**Stage 8 — Agent Interfaces**](08-agent-interfaces.md)（**两 track 共用 hub**）：学 agent 怎么跟非 API 世界互动（Computer Use / Browser Use / Code Sandbox）。或挑一个[特化分支](../README.md#️-7-阶段学习地图)、或回头来贡献这份 repo。
